...
The provider is admin-only, labelled **Fixture test content**, records provider `fixture_test`, and cannot publish. It is not an NVIDIA fallback and must never be presented as public editorial content.
