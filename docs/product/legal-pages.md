...
- postal/formal notice address where required;
- governing law and jurisdiction;
- jurisdiction-specific privacy rights and subprocessors;
- any analytics/cookie consent changes.

The sitemap includes the public trust pages. Account, admin, live-audit, login, and registration routes remain noindex.
